...
int main()
{
  ...
  if (true)
  {
    ...
    SuperTrap Robot5("Superman");
    NinjaTrap Robot4("4B");


    std::cout << "Hit points: " << Robot5.hit_points << std::endl;
    std::cout << "Max hit points: " << Robot5.max_hit_points << std::endl;
    std::cout << "Energy points: " << Robot5.energy_points << std::endl;
    std::cout << "Max energy points: " << Robot5.max_energy_points << std::endl;
    std::cout << "Level: " << Robot5.level << std::endl;
    std::cout << "Name: " << Robot5.name << std::endl;
    std::cout << "Melee attack damage: " << Robot5.melee_attack_damage << std::endl;
    std::cout << "Ranged attack damage: " << Robot5.ranged_attack_damage << std::endl;
    std::cout << "Armor damage reduction: " << Robot5.armor_damage_reduction << std::endl;
    Robot5.takeDamage(110);
    std::cout << "Energy points: " << Robot5.energy_points << std::endl;
    Robot5.beRepaired(110);
    std::cout << "Energy points: " << Robot5.energy_points << std::endl;
    Robot5.rangedAttack("Jack");
    Robot5.meleeAttack("Benny");
    Robot5.ninjaShoebox(Robot4);
    Robot5.vaulthunter_dot_exe("Billy");
  }
}
